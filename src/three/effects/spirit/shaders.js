...
export const positionFrag = `uniform vec2 resolution;
...
`;
export const quadVert = `attribute vec3 position;

void main() {
    gl_Position = vec4( position, 1.0 );
}
`;
export const throughFrag = `uniform vec2 resolution;
...
`;
export const particlesVert = `uniform sampler2D texturePosition;
...
void main() {
    ...
    gl_PointSize = particleSize / length( mvPosition.xyz ) * smoothstep(0.0, 0.2, positionInfo.w);

    gl_Position = projectionMatrix * mvPosition;

}
`;
export const particlesFrag = `// chunk(common);
